    ...
    <?php if ($mediaUrl): ?>
        <div class="tweet-media" onclick="window.location.href='/status/<?= e($tweetId) ?>'">
            ...
            <?php if ($is_video && $videoUrl): ?>
                <video controls preload="metadata" onclick="event.stopPropagation()" poster="<?= e($mediaUrl) ?>" style="width: 100%; border-radius: var(--radius-sm); max-height: 500px; background: #000;">
